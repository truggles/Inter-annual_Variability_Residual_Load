...
def return_file_info_map(region):
    ...
    info_map = { # region : # f_path, header rows
        'ERCOT': { # New files June 2020
            ...
            'wind': ['data/20200624v4_ERCO_2018_mthd3_2000-2019_wind.csv', 0, 'w_cfs', 'year'],
            'solar': ['data/20200624v4_ERCO_2018_mthd3_2000-2019_solar.csv', 0, 's_cfs', 'year'],
        ...
        'NYISO': { # New files June 2020
            ...
            'wind': ['data/20200624v4_NYIS_2018_mthd3_2000-2019_wind.csv', 0, 'w_cfs', 'year'],
            'solar': ['data/20200624v4_NYIS_2018_mthd3_2000-2019_solar.csv', 0, 's_cfs', 'year'],
        ...
        'PJM': { # New files June 2020
            ...
            'wind': ['data/20200624v4_PJM_2018_mthd3_2000-2019_wind.csv', 0, 'w_cfs', 'year'],
            'solar': ['data/20200624v4_PJM_2018_mthd3_2000-2019_solar.csv', 0, 's_cfs', 'year'],
